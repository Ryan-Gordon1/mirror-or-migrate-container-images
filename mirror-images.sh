...
readonly IMAGES_TO_TRANSFER="${IMAGES_TO_TRANSFER:-images_to_transfer.conf}"

readonly IMAGES_TO_PRESERVE_LOCALLY="${IMAGES_TO_TRANSFER:-images_to_preserve.conf}"

readonly IMAGE_REGISTRY="${SOURCE_REGISTRY_DOMAIN:-quay.io}"
readonly REGISTRY_ORG="${SOURCE_REGISTRY_ORG:-yourorg}"
